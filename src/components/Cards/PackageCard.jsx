...
const PackageCard = ({data, setViewPackages}) => {
    ...
    return (
        <>
            <div className="hidden md:inline-flex flex-col px-[25px] py-[35px] rounded-[8px] custom-shadow mr-[30px] mb-[30px]">
                <div className="flex flex-col items-start">
                    ...
                    <div className="mt-[20px] w-[100%]">
                        ...
                        <ul className="list-disc list-inside mt-[15px]">
                            {
                                data.akaList.map((aka) => {
                                    return <li className="::marker:text-[#E40443] py-[4px]">{aka}</li>
                                })
                            }
                        </ul>
